...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Aug 12 10:35:20 2014
...
INCPATH       = -I/usr/lib64/qt/mkspecs/linux-g++ -I. -I/usr/lib64/qt/include/QtCore -I/usr/lib64/qt/include/QtNetwork -I/usr/lib64/qt/include/QtGui -I/usr/lib64/qt/include -Iinclude -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/lib64/qt/lib
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt/lib -lm -ldl -lQtGui -L/usr/lib64/qt/lib -L/usr/X11R6/lib -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
install_target: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/var/lib/optiportal/hoang/Native_DecklinkCapture/./ || $(MKDIR) $(INSTALL_ROOT)/var/lib/optiportal/hoang/Native_DecklinkCapture/./ 
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/var/lib/optiportal/hoang/Native_DecklinkCapture/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/var/lib/optiportal/hoang/Native_DecklinkCapture/$(QMAKE_TARGET)"

uninstall_target:  FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/var/lib/optiportal/hoang/Native_DecklinkCapture/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/var/lib/optiportal/hoang/Native_DecklinkCapture/./ 
